...
![Схема workflow](workflow.png)

## Что вы получаете

- Канонические playbooks в `docs/playbooks/`.
- Обёртки для Claude Code и Codex (bootstrap + для интегрированного проекта).
- Фиксированный контракт документации (`SPEC.md`, `STATE.md`, `CONTEXT.md`, `CHANGELOG.md`, `PHASE_XX.md`).
- Без CLI, без runtime-зависимостей, без build-манифеста.
